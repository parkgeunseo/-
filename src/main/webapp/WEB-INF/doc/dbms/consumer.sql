...
VALUES(consumer_seq.nextval, '박근서', 'parkgeunse10', '1234', '별명', 'parkgeunseo2@naver.com', '11', '010-1234-1234', '123-456-789', 'FPS','AJE!125fD',0 ,'M');
INSERT INTO consumer(consumer_no, consumer_name, consumer_id, consumer_passwd, consumer_nickname, consumer_email,
                                  consumer_age, consumer_phone_num, consumer_pay_num, consumer_game_tend, consumer_key,grade_no,consumer_sex)
...
VALUES(consumer_seq.nextval, '박근서', 'parkgeunse17', '1234', '별명', 'parkgeunseo2@naver.com', '010-1234-1234', '123-456-789','AJE!125fD',0 );
commit;
2) 목록
...
UPDATE consumer
SET  consumer_key = 'Y'
WHERE consumer_no = 54;

UPDATE consumer
SET  consumer_passwd = '$2a$10$5Q9mJGK1WbHQOBSfckTghuD1OanY0ve11k8v3/xooVjXk4p4F8SDa'
WHERE consumer_no = 4;
