...
<td style='width: 400px;'>      
    <c:choose>
     ...
     <div>
       ...
       <a href="#" onclick="location.href='http://172.16.12.3:9090/team5/consumer/create.do'"  style="font-size: 12px;">회원가입</a> |     
       <a href="#" onclick="#" style="font-size: 12px;">고객센터</a>
     </div>
       <br><br><br><br>
     </c:when>
     ...
     <c:when test="${sessionScope.consumer_id != null && sessionScope.admin=='Y'}">
     <div>
        <a type="text" href="#" onclick="location.href='/team5/admin/sitemap.jsp'" style="font-size: 12px;" >사이트관리</a> |
     ...
     <c:when test="${sessionScope.naver_id != null && sessionScope.consumer_id == null && sessionScope.admin !='Y'}">
	     <div>
	        <a href="#" onclick="location.href='http://172.16.12.3:9090/team5/consumer/create.do'"  style="font-size: 12px;">유니크게임즈 회원가입</a> |     
          <a href="#" onclick="#" style="font-size: 12px;">고객센터</a> | 
          <a type="text" href="#" onclick="location.href='/team5/consumer/logout.do'" style="font-size: 12px;" >로그아웃</a>
	     </div>
